...
public class LlamadasComentarios {
    ...
    private static final String CREACION_COMENTARIO = "INSERT INTO Comentarios (id, nombre_usuario, id_revista, descripcion, fecha_comentario) VALUES(?, ?, ?, ?, ?)";
    ...
    public void crearComentario(String nombre_usuario, int id_revista, String descripcion) throws SQLException{
        ...
        declaracionComentario.setDate(5, fechaAgregar);
