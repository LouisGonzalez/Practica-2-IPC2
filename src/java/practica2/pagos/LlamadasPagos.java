...
public class LlamadasPagos {
    ...
    private static final String NUEVO_PAGO = "INSERT INTO Pagos_suscriptor (id, nombre_usuario, id_revista, total_acumulado) VALUES (?, ?, ?, ?)";
    ...
    public void crearPago(String nombre_usuario, int id_revista, float pago) throws SQLException{
        obtenerConexion();
