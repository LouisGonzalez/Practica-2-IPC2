<%-- 
    ...
    Created on : 1/10/2019, 04:19:40 PM
    Author     : luisGonzalez
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            ArrayList<Usuario> listar = dao.ListarAdmin(user);
        %>
        <div class="container"><br><br>
            <h1>Eliminar a un administrador:</h1>
                        <table class="table"> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="ControladorAdministrador?user=<%=usuario.getNombre_usuario()%>" method="POST">
                                            <input type="submit" name="accion" value="Eliminar" class="btn btn-primary mb-2"/>
                                        </form>
                                    </td>
                                </tr>
                                    <%}
